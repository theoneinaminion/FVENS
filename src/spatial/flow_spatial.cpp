...
//....................... Introduced by Aditya for Matrix-free LUSGS preconditioning............//
...
template<typename scalar, bool secondOrderRequested, bool constVisc>
void FlowFV<scalar,secondOrderRequested,constVisc>
::compute_fluxvec(const scalar *const u, const scalar *const gradients,
                 const scalar *const uleft, const scalar *const uright,
                 const scalar *const ug,
...
template<typename scalar, bool secondOrderRequested, bool constVisc>
StatusCode
FlowFV<scalar,secondOrderRequested,constVisc>::assemble_fluxes_face(const Vec uvec, Vec fluxvec, const int faceID) const
{
...
template<typename scalar, bool secondOrderRequested, bool constVisc>
void FlowFV<scalar,secondOrderRequested,constVisc>
::calculate_fluxvec_face(const scalar *const u, const scalar *const gradients,
	                    const scalar *const uleft, const scalar *const uright,
	                    const scalar *const ug,
